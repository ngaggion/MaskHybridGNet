...
python 2_Trainer.py --name CAMUS_NN_dual_v2 --dataset ../Dataset/CAMUS/Landmarks_3_10 --iterations 500000 --non-naive --dual --pretrain --resume ../Training/CAMUS_NN_dual/CAMUS_NN_dual.pth
python 2_Trainer.py --name CAMUS_NN_dual_v3 --dataset ../Dataset/CAMUS/Landmarks_3_10 --iterations 500000 --non-naive --dual --pretrain --resume ../Training/CAMUS_NN_dual_v2/CAMUS_NN_dual_v2.pth

python 2_Trainer.py --name CAMUS_NN_dual_full --dataset ../Dataset/CAMUS/Landmarks_3_10 --iterations 800000 --non-naive --dual --pretrain --prod
...
#python 2_Trainer.py --name Sunnybrook_3 --dataset ../Dataset/Sunnybrook/Landmarks_3_10 --iterations 500000 --val_every 10
#python 2_Trainer.py --name Sunnybrook_dual_3 --dataset ../Dataset/Sunnybrook/Landmarks_3_10 --dual --iterations 500000 --val_every 10

#python 2_Trainer.py --name Sunnybrook_2 --dataset ../Dataset/Sunnybrook/Landmarks_2_10 --iterations 500000 --val_every 10
#python 2_Trainer.py --name Sunnybrook_dual_2 --dataset ../Dataset/Sunnybrook/Landmarks_2_10 --dual --iterations 500000 --val_every 10

#python 2_Trainer.py --name Sunnybrook_4 --dataset ../Dataset/Sunnybrook/Landmarks_4_10 --iterations 500000 --val_every 10
#python 2_Trainer.py --name Sunnybrook_dual_4 --dataset ../Dataset/Sunnybrook/Landmarks_4_10 --dual --iterations 500000 --val_every 10